...
WEBSITE_DIR := ./website
DUMMY_SENSOR_DIR := ./dummies/sensor
...
help:
	...
	@echo "  make gen/dummy-sensor     - Setup dummy data generator"
	@echo ""
	...
	@echo "  make dev/dummy-sensor     - Run dummy sensor in dev mode"
	@echo ""
	@echo "  make build/websocket      - Build websocket service"
	@echo "  make build/dummy-sensor   - Build dummy sensor service"
	@echo "  make build/website        - Build website"
	@echo ""
	@echo "  make preview/websocket    - Run websocket in production mode"
	@echo "  make preview/dummy-sensor - Run dummy sensor in production mode"
...
gen: gen/websocket gen/alert-lambda gen/stats-lambda gen/website gen/dummy-sensor
...
dev/dummy-socket: gen/dummy-sensor
	@echo "Starting websocket in development mode..."
	@cd $(DUMMY_SENSOR_DIR) && air --build.bin "go run main.go"
...
build/dummy-sensor: gen/dummy-sensor
	@echo "Building dummy sensor service..."
	@mkdir -p $(DUMMY_SENSOR_DIR)/build
	@cd $(DUMMY_SENSOR_DIR) && go build -o ./build/server
...
preview/dummy-sensor: build/dummy-sensor
	@echo "Starting dummy-sensor in production mode..."
	@cd $(DUMMY_SENSOR_DIR) && ./build/server
